...
public class CardDao extends AbstractDao<Card, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property VideoStory = new Property(35, String.class, "videoStory", false, "VIDEO_STORY");
        public final static Property JapaneseVideoStory = new Property(36, String.class, "japaneseVideoStory", false, "JAPANESE_VIDEO_STORY");
        public final static Property WebsiteUrl = new Property(37, String.class, "websiteUrl", false, "WEBSITE_URL");
        public final static Property NonIdolizedMaxLevel = new Property(38, String.class, "nonIdolizedMaxLevel", false, "NON_IDOLIZED_MAX_LEVEL");
        public final static Property IdolizedMaxLevel = new Property(39, String.class, "idolizedMaxLevel", false, "IDOLIZED_MAX_LEVEL");
        public final static Property OwnedCards = new Property(40, String.class, "ownedCards", false, "OWNED_CARDS");
        public final static Property TransparentImage = new Property(41, String.class, "transparentImage", false, "TRANSPARENT_IMAGE");
        public final static Property TransparentIdolizedImage = new Property(42, String.class, "transparentIdolizedImage", false, "TRANSPARENT_IDOLIZED_IMAGE");
        public final static Property TransparentUrPair = new Property(43, String.class, "transparentUrPair", false, "TRANSPARENT_UR_PAIR");
        public final static Property TransparentIdolizedUrPair = new Property(44, String.class, "transparentIdolizedUrPair", false, "TRANSPARENT_IDOLIZED_UR_PAIR");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CARD\" (" + //
                ...
                "\"VIDEO_STORY\" TEXT," + // 35: videoStory
                "\"JAPANESE_VIDEO_STORY\" TEXT," + // 36: japaneseVideoStory
                "\"WEBSITE_URL\" TEXT," + // 37: websiteUrl
                "\"NON_IDOLIZED_MAX_LEVEL\" TEXT," + // 38: nonIdolizedMaxLevel
                "\"IDOLIZED_MAX_LEVEL\" TEXT," + // 39: idolizedMaxLevel
                "\"OWNED_CARDS\" TEXT," + // 40: ownedCards
                "\"TRANSPARENT_IMAGE\" TEXT," + // 41: transparentImage
                "\"TRANSPARENT_IDOLIZED_IMAGE\" TEXT," + // 42: transparentIdolizedImage
                "\"TRANSPARENT_UR_PAIR\" TEXT," + // 43: transparentUrPair
                "\"TRANSPARENT_IDOLIZED_UR_PAIR\" TEXT);"); // 44: transparentIdolizedUrPair
    }
    ...
    public Card readEntity(Cursor cursor, int offset) {
        Card entity = new Card( //
            ...
            cursor.isNull(offset + 35) ? null : cursor.getString(offset + 35), // videoStory
            cursor.isNull(offset + 36) ? null : cursor.getString(offset + 36), // japaneseVideoStory
            cursor.isNull(offset + 37) ? null : cursor.getString(offset + 37), // websiteUrl
            cursor.isNull(offset + 38) ? null : cursor.getString(offset + 38), // nonIdolizedMaxLevel
            cursor.isNull(offset + 39) ? null : cursor.getString(offset + 39), // idolizedMaxLevel
            cursor.isNull(offset + 40) ? null : cursor.getString(offset + 40), // ownedCards
            cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41), // transparentImage
            cursor.isNull(offset + 42) ? null : cursor.getString(offset + 42), // transparentIdolizedImage
            cursor.isNull(offset + 43) ? null : cursor.getString(offset + 43), // transparentUrPair
            cursor.isNull(offset + 44) ? null : cursor.getString(offset + 44) // transparentIdolizedUrPair
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Card entity, int offset) {
        ...
        entity.setVideoStory(cursor.isNull(offset + 35) ? null : cursor.getString(offset + 35));
        entity.setJapaneseVideoStory(cursor.isNull(offset + 36) ? null : cursor.getString(offset + 36));
        entity.setWebsiteUrl(cursor.isNull(offset + 37) ? null : cursor.getString(offset + 37));
        entity.setNonIdolizedMaxLevel(cursor.isNull(offset + 38) ? null : cursor.getString(offset + 38));
        entity.setIdolizedMaxLevel(cursor.isNull(offset + 39) ? null : cursor.getString(offset + 39));
        entity.setOwnedCards(cursor.isNull(offset + 40) ? null : cursor.getString(offset + 40));
        entity.setTransparentImage(cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41));
        entity.setTransparentIdolizedImage(cursor.isNull(offset + 42) ? null : cursor.getString(offset + 42));
        entity.setTransparentUrPair(cursor.isNull(offset + 43) ? null : cursor.getString(offset + 43));
        entity.setTransparentIdolizedUrPair(cursor.isNull(offset + 44) ? null : cursor.getString(offset + 44));
     }
